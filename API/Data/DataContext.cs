...
namespace API.Data
{
        ...
        IdentityRoleClaim<int>, IdentityUserToken<int>>
    {
        ...
        // public DbSet<AppUser> Users { get; set; } // Already contained in the Identity framework
        public DbSet<UserLike> Likes { get; set; } // Adding a DbSet to our UserLike
        public DbSet<Message> Messages { get; set; }

        // Overriding the OnModelCreating method that is inside the DbContext class
